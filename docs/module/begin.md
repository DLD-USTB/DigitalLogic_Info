...
当你第一次进入数逻实验的课堂，你就会拿到这个红色小盒子装上的FPGA开发板——EGO1。而开发板中央的那块芯片，就是大名鼎鼎的FPGA。你已经在数逻的第一章学到过，FPGA是一种可编程电路，就像你痛恨的数电实验箱一样。但是不用担心，FPGA开发板比数电实验箱更为健壮，很少出现实验硬件故障的问题。不过不用担心自己无法充分受到调试错误的训练，vivado很好的接替数电实验箱完成了这一职责。
...
![image-20221017205216185](../pic.asset//image-20221017205216185.png)

![image-20221017205234472](../pic.asset//image-20221017205234472.png)
...
![image-20221017193945166](../pic.asset//image-20221017193945166.png)
...
1. 首先，打开Vivado, 在Quick Start部分点击Create Project
   ...
   ![image-20221017210740393](../pic.asset//image-20221017210740393.png)

2. 点击Next进入选择路径的页面，选择项目名称和任意你喜欢的路径，但是路径不要带中文也不要过长。

   ![image-20221017210922570](../pic.asset//image-20221017210922570.png)

3. 选择项目类型`RTL Project`

   ![image-20221017211021425](../pic.asset//image-20221017211021425.png)

4. 添加源文件和约束（可以跳过）

   ![image-20221017211119890](../pic.asset//image-20221017211119890.png)

   ![image-20221017211130883](../pic.asset//image-20221017211130883.png)

5. 接下来是选择板子的型号，不同的FPGA的资源数量，速度，管脚功能都是不同的，一定一定要选择本课程使用的FPGA芯片`xc7a35tcsg324`。

![image-20221017211458606](../pic.asset//image-20221017211458606.png)
...
7. 进入vivado，界面如下所示，
   ...
   ![image-20221017211704211](../pic.asset//image-20221017211704211.png)

8. 创建设计文件

   1. 点击下面的加号

      ![image-20221017211753033](../pic.asset//image-20221017211753033.png)
   ...
   2. 点开后，我们会看到下面的界面，其中包括三个部分，分别是
      ...
      * 创建或增加仿真文件（simulation sources），主要是电路的仿真激励。
      ...
      ![image-20221017212610562](../pic.asset//image-20221017212610562.png)

   3. 你可以选择添加现有文件或目录，或者你也可以创建新文件。这里我们创建一个新文件

      1. ![image-20221017213150219](../pic.asset/image-20221017213150219.png)
...
9. 编写文件代码，把上面的代码放到Vivado中。
   ...
   ![image-20221017213523356](../pic.asset/image-20221017213523356.png)
...
10. 接下来点击综合，将这个Verilog文件变成网表文件。这里通过在“Flow Navigator”栏中的“Synthesis”下点击“Run Synthesis”。右上角的进度条 “Running synth_design”指示正在对工程进行综合。
    ...
    ![image-20221017213736103](../pic.asset/image-20221017213736103.png)
...
13. 点击保存，会弹出一个保存约束文件的选项。这个文件是实际上起到了对IO进行约束的文件。
    ...
    ![image-20221017214941010](../pic.asset/image-20221017214941010.png)

    14. 完成后点击Implemention和Generate Bitstream,生成bit流

    15. 用USB Type C连接板卡和电脑，打开板卡开关。打开Hardware Manger，点击Open Target，Auto Connect

        ![image-20221017215459350](../pic.asset/image-20221017215459350.png)

        16. 点击Program device

            ![image-20221017215653435](../pic.asset/image-20221017215653435.png)

            ![image-20221017215704455](../pic.asset/image-20221017215704455.png)
